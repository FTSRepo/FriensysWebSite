...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-sm font-medium text-text-primary transition-all hover:text-accent-primary [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
