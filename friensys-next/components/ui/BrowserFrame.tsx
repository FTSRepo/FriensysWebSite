...
export function BrowserFrame({ src, alt, width = 1200, height = 800, className }: BrowserFrameProps) {
  return (
    <div className={cn("overflow-hidden rounded-[var(--radius-lg)] border border-border-subtle bg-bg-elevated shadow-[var(--shadow-lg)]", className)}>
      <div className="flex items-center gap-1.5 border-b border-border-subtle bg-bg-overlay px-4 py-3">
        ...
        <span className="h-2.5 w-2.5 rounded-full bg-border-strong/60" aria-hidden="true" />
